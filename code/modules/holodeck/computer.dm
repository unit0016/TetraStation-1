...
Holodeck finds the location of mapped_start_area and loads offline_program in it on LateInitialize.
It then passes its program templates to Holodeck.js in the form of program_cache and emag_programs. When a user selects a program the
...
/obj/machinery/computer/holodeck
	...
	var/area/mapped_start_area = /area/special/holodeck/rec_center
...
/obj/machinery/computer/holodeck/LateInitialize()//from here linked is populated and the program list is generated. its also set to load the offline program
	...
	if(istype(computer_area, /area/special/holodeck))
