...
#define SMOOTH_GROUP_FLOOR_ASH S_TURF(4)				///turf/open/floor/plating/ashplanet/ash
#define SMOOTH_GROUP_FLOOR_ASH_ROCKY S_TURF(5)			///turf/open/floor/plating/ashplanet/rocky
...
#define SMOOTH_GROUP_CARPET S_TURF(9)					///turf/open/floor/carpet
#define SMOOTH_GROUP_CARPET_BLACK S_TURF(10)			///turf/open/floor/carpet/black
#define SMOOTH_GROUP_CARPET_BLUE S_TURF(11)				///turf/open/floor/carpet/blue
#define SMOOTH_GROUP_CARPET_CYAN S_TURF(12)				///turf/open/floor/carpet/cyan
#define SMOOTH_GROUP_CARPET_GREEN S_TURF(13)			///turf/open/floor/carpet/green
#define SMOOTH_GROUP_CARPET_ORANGE S_TURF(14)			///turf/open/floor/carpet/orange
#define SMOOTH_GROUP_CARPET_PURPLE S_TURF(15)			///turf/open/floor/carpet/purple
#define SMOOTH_GROUP_CARPET_RED	S_TURF(16)				///turf/open/floor/carpet/red
#define SMOOTH_GROUP_CARPET_ROYAL_BLACK S_TURF(17)		///turf/open/floor/carpet/royalblack
#define SMOOTH_GROUP_CARPET_ROYAL_BLUE S_TURF(18)		///turf/open/floor/carpet/royalblue

#define SMOOTH_GROUP_CLOSED_TURFS S_TURF(19)			///turf/closed
#define SMOOTH_GROUP_MATERIAL_WALLS S_TURF(20)			///turf/closed/wall/material
#define SMOOTH_GROUP_SYNDICATE_WALLS S_TURF(21)			///turf/closed/wall/r_wall/syndicate, /turf/closed/indestructible/syndicate
#define SMOOTH_GROUP_HOTEL_WALLS S_TURF(22)				///turf/closed/indestructible/hotelwall
#define SMOOTH_GROUP_MINERAL_WALLS S_TURF(23)			///turf/closed/mineral, /turf/closed/indestructible
#define SMOOTH_GROUP_BOSS_WALLS S_TURF(24)				///turf/closed/indestructible/riveted/boss
#define SMOOTH_GROUP_SURVIVAL_TITANIUM_WALLS S_TURF(25)	///turf/closed/wall/mineral/titanium/survival
